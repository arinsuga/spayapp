...
namespace APPBASE.Controllers
{
    public partial class Transaction_inController : Controller
    {
        ...
        private Transaction_indetailVM CREATEMapekskul_ViewModel(Transaction_indetailVM poViewModel, Transaction_indetailVM poViewModel_posted)
        {
            //Update ViewModel
            Transaction_indetailVM oViewModel = poViewModel;
            ...
            if (oViewModel.DETAIL != null) {
                //DELETE SPP
                oViewModel.DETAIL = this.removeItem(oViewModel, valFLAG.FLAG_TRINTYPE_EKSKUL);
        ...
        private Transaction_indetailVM CREATEMapekskul_ViewModelINST(Transaction_indetailVM poViewModel)
        {
            //Update ViewModel
            Transaction_indetailVM oViewModel = poViewModel;
            ...
            oViewModel.MONTHLY_INST.INST_DESC = "Ekstrakurikuler Tahun Ajaran " + oViewModel.YEAR_SHORTDESC;
            ...
            //SET MAP TO EKSKUL-MODEL
            oViewModel.MONTHLY_INST_EKSKUL = oViewModel.MONTHLY_INST;
            return oViewModel;
        } //End private Transaction_indetailVM CREATEMapspp_ViewModel(Transaction_indetailVM poViewModel, Transaction_indetailVM poViewModel_par)
        //ADD
        private Transaction_indetailVM addDetail_EKSKUL(Transaction_indetailVM poViewModel, MonthsppVM poItem)
        {
            Transaction_indetailVM oViewModel = poViewModel;
            ...
            return oViewModel;
        } //End private Transaction_indetailVM addDetail_EKSKUL(Transaction_indetailVM poViewModel, MonthsppVM poItem)
        private Transaction_indetailVM addDetail_EKSKULfirst(Transaction_indetailVM poViewModel, MonthsppVM poItem)
        {
            Transaction_indetailVM oViewModel = poViewModel;
            MonthsppVM item = poItem;
            Byte? nMONTH1 = oViewModel.MONTHSPP2;
            ...
            {
                //Add Transaction Detail
                oViewModel = this.addDetail_EKSKUL(oViewModel, item);
            } //End if ((item.MONTHSPP_SEQNO >= oViewModel.MONTHSPP1.MONTHSPP_SEQNO) &&


            return oViewModel;
        } //End private Transaction_indetailVM addDetail_EKSKULfirst(Transaction_indetailVM poViewModel, MonthsppVM poItem)
        private Transaction_indetailVM addDetail_EKSKULnext(Transaction_indetailVM poViewModel, MonthsppVM poItem)
        {
            Transaction_indetailVM oViewModel = poViewModel;
            MonthsppVM item = poItem;
            Byte? nMONTH1 = oViewModel.MONTHSPP2;
        ...
        //GET
        private Installment_indetailVM getINST_EKSKUL(Transaction_indetailVM poViewModel)
        {
            return this.getINST_MONTHLY(poViewModel);;
        } //End private Installment_indetailVM getINST_EKSKUL(Transaction_indetailVM poViewModel)
        private Transaction_inddetailVM getItem_EKSKUL(MonthsppVM poMonthitem, Transaction_indetailVM poViewModel)
        {
            return this.getItem_MONTHLY(poMonthitem, poViewModel);
        } //End private Transaction_inddetailVM getItem_EKSKUL(MonthsppVM poMonthitem, Transaction_indetailVM poViewModel)

        //issue#5
        private Transaction_indetailVM CREATEInitekskul_ViewModel_BACKUP(Transaction_indetailVM poViewModel)
        {
            //Update ViewModel
            Transaction_indetailVM oViewModel = poViewModel;
            //Get INST MONTHLY
        ...
        //issue#5
        private Transaction_indetailVM addDetail_EKSKULnext_BACKUP(Transaction_indetailVM poViewModel, MonthsppVM poItem)
        {
            Transaction_indetailVM oViewModel = poViewModel;
            MonthsppVM item = poItem;
            ...
            return oViewModel;
        } //End private Transaction_indetailVM addDetail_EKSKULnext(Transaction_indetailVM poViewModel, MonthsppVM poItem)
