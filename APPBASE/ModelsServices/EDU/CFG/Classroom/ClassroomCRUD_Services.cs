...
namespace APPBASE.Models
{
    public class ClassroomCRUD
    {
        ...
        //Constructor
        public ClassroomCRUD() { } //End public ClassroomCRUD()
        ...
        public void Update(ClassroomdetailVM poViewModel)
        {
            try
            {
                using (var db = new DBMAINContext())
                {
                    Classroom oModel = db.Classrooms.AsNoTracking().SingleOrDefault(fld => fld.ID == poViewModel.ID);
                    //Map Form Data
                    oModel.InjectFrom(poViewModel);
                    //Set Field Header
    ...
    } //End public class ClassroomCRUD
