...
namespace APPBASE.Models
{
    public class Installment_inCRUD
    {
        ...
        //Constructor
        public Installment_inCRUD() { } //End public Installment_inCRUD()
        public void Create(Installment_indetailVM poViewModel) {
            try
            {
                using (var db = new DBMAINContext())
                {
                    Installment_in oModel = new Installment_in();
                    //Map Form Data
        ...
        public void Update(Installment_indetailVM poViewModel)
        {
            try
            {
                using (var db = new DBMAINContext())
                {
                    Installment_in oModel = db.Installment_ins.AsNoTracking().SingleOrDefault(fld => fld.ID == poViewModel.ID);
                    //Map Form Data
                    oModel.InjectFrom(poViewModel);
                    //Set Field Header
