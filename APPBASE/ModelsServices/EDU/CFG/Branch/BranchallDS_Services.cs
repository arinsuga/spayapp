...
{
    public class BranchallDS
    {
        //Constructor
        public BranchallDS() { } //End public BranchDS
        public List<BranchdetailVM> getDatalist()
        {
            ...
            {
                var oQRY = from tb in db.Branchall_infos
        ...
        public List<BranchdetailVM> getDatalist_lookup()
        {
            ...
            return vReturn;
        } //End public List<BranchlookupVM> getDatalist_lookup()
    } //End public class BranchallDS
