...
namespace APPBASE.Controllers
{
    ...
    {
        public ActionResult CreateSPPDenda()
        {
            ...
            oViewModel = CREATEInitsppdenda_ViewModel(oViewModel);

            //Update session
            this.updateSESSIOAN_Transaction(oViewModel);
            this.prepareData(oViewModel);

            return View("~/Views/Transaction_in/1SPPDenda/CreateSPPDenda.cshtml", oViewModel);
        } //End public ActionResult CreateSPPDenda()
