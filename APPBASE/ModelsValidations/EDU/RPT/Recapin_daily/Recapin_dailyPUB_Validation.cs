...
{
    public partial class Recapin_daily_Validation
    {
        ...
        //Constructor
        public Recapin_daily_Validation(Transaction_indetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Recapin_daily_Validation()
    ...
    } //End public partial class Recapin_daily_Validation
