...
namespace APPBASE.Models
{
    ...
    } //End public partial class EmployeelistVM
    public partial class EmployeedetailVM
    {
        public int? ID { get; set; }
        public Byte? DTA_STS { get; set; }
        public string NIP { get; set; }
    ...
    } //End public partial class EmployeedetailVM

    public partial class EmployeelookupVM
    {
        public int? ID { get; set; }
        public string NIP { get; set; }
        public string NAME { get; set; }
