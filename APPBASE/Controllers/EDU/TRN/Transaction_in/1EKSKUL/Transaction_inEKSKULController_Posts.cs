...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult CreateEKSKUL(Transaction_indetailVM poViewModel) {
            //Update ViewModel
            ...
            if (oViewModel.MONTHLY_INST_EKSKUL.DTA_STS == valFLAG.FLAG_DTA_STS_CREATE)
            {
            ...
            oViewModel = this.CREATEMapekskul_ViewModel(oViewModel, poViewModel);
            oViewModel = this.CREATEMapekskul_ViewModelINST(oViewModel);
